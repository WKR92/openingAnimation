...
})({"66lZX":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 52444;
...
var _gsapCSSRulePlugin = require("gsap/CSSRulePlugin");
var _lodashDebounce = require('lodash.debounce');
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _lodashDebounceDefault = _parcelHelpers.interopDefault(_lodashDebounce);
_gsap.gsap.registerPlugin(_gsapCSSRulePlugin.CSSRulePlugin);
const rule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".box3:before");
const choseAfterRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".chosen::after");
...
window.addEventListener('scroll', _lodashDebounceDefault.default(rotateCube, 20));
// contactBtn
...
clickHolder.addEventListener('mouseenter', () => {
  const mouseAnim = _gsap.gsap.timeline();
  mouseAnim.to(clickHolder_icon, {
    height: "1.5rem",
    width: '1.5rem',
    margin: '0.25rem',
    duration: 0.10
...
scrollHolder.addEventListener('mouseenter', () => {
  const mouseAnim = _gsap.gsap.timeline();
  mouseAnim.to(scrollHolder_icon, {
    height: "1.25rem",
    width: '1.25rem',
    margin: '0.125rem',
    duration: 0.10
  }).to(scrollHolder_icon, {
    height: "1.5rem",
    width: '1.5rem',
    margin: '0rem',
    duration: 0.10,
...
// surprise section
const frontFaceAfterRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--front::after");
const topFaceAfterRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--top::after");
const backFaceAfterRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--back::after");
const bottomFaceAfterRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--bottom::after");
const rightFaceAfterRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--right::after");
const leftFaceAfterRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--left::after");
const frontFaceBeforeRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--front::before");
const topFaceBeforeRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--top::before");
const backFaceBeforeRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--back::before");
const bottomFaceBeforeRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--bottom::before");
const rightFaceBeforeRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--right::before");
const leftFaceBeforeRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".cube__face--left::before");
const changeBtn = document.querySelector('.changeBtn');
const initialBtn = document.querySelector('.initialBtn');
changeBtn.addEventListener('click', e => {
  e.preventDefault();
  e.stopPropagation();
  const changeFacesBgs = _gsap.gsap.timeline();
  changeFacesBgs.to([frontFaceBeforeRule, topFaceBeforeRule, backFaceBeforeRule, bottomFaceBeforeRule, rightFaceBeforeRule, leftFaceBeforeRule], {
    cssRule: {
      opacity: 0.6
    },
    duration: 1
  }).to([frontFaceAfterRule, topFaceAfterRule, backFaceAfterRule, bottomFaceAfterRule, rightFaceAfterRule, leftFaceAfterRule], {
    cssRule: {
      opacity: 0
    },
    duration: 1
...
initialBtn.addEventListener('click', e => {
  ...
  e.stopPropagation();
  const changeFacesBgs = _gsap.gsap.timeline();
  changeFacesBgs.to([frontFaceAfterRule, topFaceAfterRule, backFaceAfterRule, bottomFaceAfterRule, rightFaceAfterRule, leftFaceAfterRule], {
    cssRule: {
      opacity: 0.6
    },
    duration: 1
  }, "-=1").to([frontFaceBeforeRule, topFaceBeforeRule, backFaceBeforeRule, bottomFaceBeforeRule, rightFaceBeforeRule, leftFaceBeforeRule], {
    cssRule: {
      opacity: 0
    },
    duration: 1
...
},{"gsap":"1iecp","gsap/CSSRulePlugin":"HVnEM","lodash.debounce":"7pUaJ","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1iecp":[function(require,module,exports) {
var define;
...
},{}],"HVnEM":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "CSSRulePlugin", function () {
...
},{}],"7pUaJ":[function(require,module,exports) {
...
},{}]},["66lZX","5rkFb"], "5rkFb", "parcelRequiref117")
