...
const underTopFaceRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".under_face_top::after");
const choseAfterRule = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".chosen::after");
const homeLi = _gsapCSSRulePlugin.CSSRulePlugin.getRule(".under_face_top::after");
...
faceTop.addEventListener('click', event => {
  ...
  _gsap.gsap.to(underTopFaceRule, {
    cssRule: {
      right: '100%'
    },
    duration: .5,
