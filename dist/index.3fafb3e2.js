...
let bgColor = _gsap.gsap.getProperty('.box1', "backgroundImage");
const tl = _gsap.gsap.timeline();
tl.from(['.box3', '.box2', '.box1'], {
  scaleY: 0,
  transformOrigin: 'top',
  duration: .75
}).to(rule, {
...
},{"gsap":"1iecp","gsap/CSSRulePlugin":"HVnEM"}],"1iecp":[function(require,module,exports) {
var define;
